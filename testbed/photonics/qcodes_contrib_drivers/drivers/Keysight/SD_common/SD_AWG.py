...
class SD_AWG(SD_Module):
    ...
    def set_marker_config(self, channel_number: int, markerMode: int,
        ...
        Args:
            ...
            (old) markerValue : 0 = marker signal is default low, pulses high. 1 = marker signal is default high, pulses low
            (new) markerValue : 1 = marker signal is default low, pulses high. 0 = marker signal is default high, pulses low
